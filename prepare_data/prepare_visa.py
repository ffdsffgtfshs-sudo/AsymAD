...
parser.add_argument('--data-folder', default='/data/disk2T1/guoj/VisA/', type=str,
                    help='the path to downloaded VisA dataset')
parser.add_argument('--save-folder', default='/data/disk2T1/guoj/VisA_pytorch/', type=str,
                    help='the target path to save the reorganized VisA dataset facilitating data loading in pytorch')
parser.add_argument('--split-file', default='/data/disk2T1/guoj/VisA/split_csv/1cls.csv', type=str,
